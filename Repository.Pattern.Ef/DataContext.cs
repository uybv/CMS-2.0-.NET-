...
namespace Repository.Pattern.Ef
{
    public class DataContext : DbContext, IDataContextAsync
    {
        ...
        private readonly Assembly _mefAssemblyCatalog;
        bool _disposed;
        #endregion Private Fields

        public DataContext(string nameOrConnectionString, Assembly mefAssemblyCatalog) : base(nameOrConnectionString)
        {
            _instanceId = Guid.NewGuid();
            _mefAssemblyCatalog = mefAssemblyCatalog;
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            catalog.Catalogs.Add(new AssemblyCatalog(_mefAssemblyCatalog));
            var container = new CompositionContainer(catalog);
            //container.ComposeExportedValue("schema", schema);
            container.ComposeParts(contextConfiguration);

            foreach (IEntityConfiguration configuration in contextConfiguration.Configurations)
            {
